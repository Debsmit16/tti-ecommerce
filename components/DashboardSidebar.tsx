...
const DashboardSidebar = () => {
  return (
    <div className="xl:w-[400px] bg-gradient-to-b from-tti-primary to-tti-secondary h-full max-xl:w-full shadow-xl">
      <Link href="/admin">
        <div className="flex gap-x-2 w-full hover:bg-tti-secondary/50 cursor-pointer items-center py-6 pl-5 text-xl text-white transition-all duration-300">
          <MdDashboard className="text-2xl" />{" "}
          <span className="font-normal">Dashboard</span>
        </div>
      </Link>
      <Link href="/admin/orders">
        <div className="flex gap-x-2 w-full hover:bg-tti-secondary/50 transition-all duration-300 cursor-pointer items-center py-6 pl-5 text-xl text-white">
